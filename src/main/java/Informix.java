...
public class Informix {
    ...
    public Informix(String operation, String filePath, String flags)
    {
        try {
            ...
            parser = FrontendFactory.createParser("Informix", "top-down", source);
    ...
    private static final String USAGE =
            "Usage: Informix execute|compile " + FLAGS + " <source file path>";
    ...
    public static void main(String args[])
    {
        try {
            ...
            if (i < args.length) {
                String path = args[i];
                new Informix(operation, path, flags);
            }
            else {
                throw new Exception();
            }
